...
export const getApprove = () => {
  ...
  const bodyData = {
    ...
    "jql": `(labels = APROBADO AND (not TOP = TOP1 AND not TOP = TOP2 AND not TOP = TOP3 AND not TOP = TOP4 AND not TOP = TOP5)) AND (${sebaId} ${caroId} ${matiId} ${JuliId} ${davidId} ${lucianoId} ${leanId} ${alcidesId})`
  }
