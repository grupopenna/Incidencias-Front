								...
								<TableBody className='text-white cursor-pointer'>
										{incidentOrdered?.map((inciden, index) => {
												...
												return <TableRow
														...
														<TableCell className='text-center'>{inciden?.fields?.reporter?.displayName || <i>Sin asignar</i>}</TableCell>
														...
														<TableCell className='text-center'>{inciden?.fields?.updated}</TableCell>
												</TableRow>
										})}
								</TableBody>
						</Table>}
