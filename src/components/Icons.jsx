...
export function SimpleArrowUp() {
  return (
    <svg className="h-6 w-6 text-fontPlaceholder" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path stroke="none" d="M0 0h24v24H0z" />
...
export function IconFiles() {
  return (
    <svg className="h-20 w-20" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path stroke="none" d="M0 0h24v24H0z" />
...
export function ImgFiles() {
  return (
    <svg className="h-20 w-20" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1" stroke="#8C9BAB" fill="none" strokeLinecap="round" strokeLinejoin="round">
